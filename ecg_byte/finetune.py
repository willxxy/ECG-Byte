...
def main(rank, world_size):
    ...
    directory_path = f'./runs/{args.seed}/{args.model}_{args.dataset}_{args.lr}_{args.beta1}_{args.beta2}_{args.eps}_{args.weight_decay}_{args.warmup}_{args.batch_size}_{args.epochs}_{args.pad_to_max}_{args.toy}'

    if args.log:
        wandb.init(
            project = 'bpe-trans',
            name = f'{args.seed}_{args.model}_{args.dataset}_{args.lr}_{args.beta1}_{args.beta2}_{args.eps}_{args.weight_decay}_{args.warmup}_{args.batch_size}_{args.epochs}_{args.toy}',
            config = {
                'model' : args.model,
